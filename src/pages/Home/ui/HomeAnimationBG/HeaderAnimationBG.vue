  ...
  <div ref="layer" class="home-animation-bg">
    ...
    <div class="star-container-mask" :style="{ maskImage: `url(${require('/public/images/masks/main-mask.svg')})` }">
      ...
      <div
          ...
          class="star-container"
          id="shape-beta"
          :style="{ maskImage: `url(${require('/public/images/masks/beta-mask.svg')})` }"
          @click="playStarAnimation"
      >
      </div>
      <div
          ...
          class="star-container"
          id="shape-gamma"
          :style="{ maskImage: `url(${require('/public/images/masks/gamma-mask.svg')})` }"
          @click="playStarAnimation"
      >
      </div>
    </div>
...
import {charAnimation, gammaAnimation, starAnimation, useShapeAnimation} from "./animations";
...
export default defineComponent({
  ...
  setup() {
    ...
    const gammaAnimationShape = computed(() => gammaAnimation(gammaShape.value))
